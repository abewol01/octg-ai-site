...
const verticals = [
  {
    ...
    icon: Factory,
    description: 'We configure the platform around your blast-to-ship workflow. Track pipes from arrival through blasting, coating, QC, and load out. Generate barcodes at the final bench. Export manifests with one click.',
    features: ['Work order tracking', 'Barcode generation', 'VLX QC integration', 'Manifest export'],
  },
  {
    name: 'Pipe Yards & Distributors',
    icon: Warehouse,
    description: 'Configured for your yard layout, storage zones, and client delivery requirements. Know exactly where every pipe is, what condition it\'s in, and when it\'s moving. Give your clients real-time visibility.',
    features: ['Yard zone mapping', 'Storage capacity tracking', 'Client-ready exports', 'Barcode scanning'],
  },
  {
    name: 'E&P Operators',
    icon: Droplets,
    description: 'Configured with your project specifications and supplier quality standards. MTR.AI checks compliance against your custom specs — not just industry minimums. Digital product passports give your engineering team full traceability.',
  ...
  },
  {
    ...
    icon: ClipboardCheck,
    vlx: true,
    description: "Integrated with your VLX inspection workflow and client reporting requirements. Your inspection data doesn't just live in a report — it becomes part of the pipe's permanent digital record. Deliver more value to your clients.",
