export default function TrackerStatusMockup() {
  const stages = [
    ...
    { label: 'Blasting', color: 'bg-amber-400', textColor: 'text-amber-700 dark:text-amber-300' },
    { label: 'Coating', color: 'bg-indigo-400', textColor: 'text-indigo-700 dark:text-indigo-300' },
    { label: 'QC', color: 'bg-purple-400', textColor: 'text-purple-700 dark:text-purple-300' },
    { label: 'Load Out', color: 'bg-orange-400', textColor: 'text-orange-700 dark:text-orange-300' },
